...
ln -s $(brew --prefix openssl@1.1)/include/openssl /usr/include
ln -s /usr/local//Cellar/openssl@1.1/1.1.1s/lib/libssl.dylib /usr/lib/libssl.dylib
ln -s /usr/local//Cellar/openssl@1.1/1.1.1s/lib/libssl.a /usr/lib/libssl.a
ln -s /usr/local//Cellar/openssl@1.1/1.1.1s/lib/libcrypto.a /usr/lib/libcrypto.a
ln -s /usr/local//Cellar/openssl@1.1/1.1.1s/lib/libcrypto.dylib /usr/lib/libcrypto.dylib

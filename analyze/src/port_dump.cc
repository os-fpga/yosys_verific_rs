        ...
        case ID_VHDLIDREF:
            {
                ...
                return parseVhdlExpression(id->GetInitAssign());
            }
        ...
        FOREACH_ARRAY_ITEM(ports, j, port) {
            ...
            switch(type->GetClassId()) {
                case ID_VHDLINDEXEDNAME:
                    portType = type->GetPrefix()->OrigName();
                    unsigned i ;
                    ...
                    break; 
                case ID_VHDLIDREF:
                    portType = static_cast<VhdlIdRef*>(type)->GetSingleId()->Name();
                    break; 
                case ID_VHDLEXPLICITSUBTYPEINDICATION:
                    portType = type->GetTypeMark()->Name();

...
module wrapper_primitive_example_design_6(clk, in, rst, q_p, q_n, oddr_en, ibuf_oe1, ibuf_oe2, ibuf_oe3, ibuf_oe4);
  input clk;
  input ibuf_oe1;
  input ibuf_oe2;
  input ibuf_oe3;
  ...
  wire rst_i_buf_out;
  primitive_example_design_6 _0_ (
    .dffre_out(dffre_out),
    .oddr_out(oddr_out),
    .rst_i_buf_out(rst_i_buf_out)
  );
  interface_primitive_example_design_6 _1_ (
    .clk(clk),
    .dffre_out(dffre_out),
    .ibuf_oe1(ibuf_oe1),
    .ibuf_oe2(ibuf_oe2),

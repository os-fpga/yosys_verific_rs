...
module and2(a, b, c, clk, reset);
  ...
  wire \$abc$420$techmap$techmap341$abc$187$auto$blifparse.cc:362:parse_blif$188.$logic_not$/home/manadher/work/Feb24/yosys_rs27/yosys_verific_rs/yosys/install/bin/../share/yosys/rapidsilicon/genesis3/ffs_map.v:19$278_Y ;
  ...
  LUT1 #(
    ...
    .Y(\$abc$420$techmap$techmap341$abc$187$auto$blifparse.cc:362:parse_blif$188.$logic_not$/home/manadher/work/Feb24/yosys_rs27/yosys_verific_rs/yosys/install/bin/../share/yosys/rapidsilicon/genesis3/ffs_map.v:19$278_Y ),
    .A(reset)
  );
  (* module_not_derived = 32'h00000001 *)
  ...
  DFFRE \$abc$187$auto$blifparse.cc:362:parse_blif$188  (
    ...
    .E(1'h1),
    .Q(c),
    .R(\$abc$420$techmap$techmap341$abc$187$auto$blifparse.cc:362:parse_blif$188.$logic_not$/home/manadher/work/Feb24/yosys_rs27/yosys_verific_rs/yosys/install/bin/../share/yosys/rapidsilicon/genesis3/ffs_map.v:19$278_Y )
  );
endmodule

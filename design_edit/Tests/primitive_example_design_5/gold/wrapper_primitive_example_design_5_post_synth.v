...
module wrapper_primitive_example_design_5(in, ibuf2_en, rst, clk, ibuf1_en, ibuf3_en, ibuf4_en, ibuf5_en, obuft_ds_en1, obuft_ds_en2, obuft_ds_en3, iddr_en, q_p, q_n);
  input clk;
  input ibuf1_en;
  input ibuf2_en;
  input ibuf3_en;
  ...
  wire rst_i_buf_out;
  primitive_example_design_5 \$auto$rs_design_edit.cc:559:execute$399  (
...
module interface_primitive_example_design_5(in, ibuf2_en, rst, clk, ibuf1_en, ibuf3_en, ibuf4_en, ibuf5_en, obuft_ds_en1, obuft_ds_en2, obuft_ds_en3, iddr_en, q_p, iddr_out, dffre_out, rst_i_buf_out, \$auto$hierarchy.cc:1408:execute$1 , \$auto$hierarchy.cc:1408:execute$2 , \$auto$hierarchy.cc:1408:execute$3 );

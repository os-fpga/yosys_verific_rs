...
module wrapper_primitive_example_design_5(in, ibuf2_en, rst, clk, ibuf1_en, ibuf3_en, ibuf4_en, ibuf5_en, obuft_ds_en1, obuft_ds_en2, obuft_ds_en3, iddr_en, q_p, q_n);
  ...
  wire rst_i_buf_out;
  primitive_example_design_5 _3_ (
    ._0_(_0_),
    ._1_(_1_),
    ._2_(_2_),
    .dffre_out(dffre_out),
  ...
  interface_primitive_example_design_5 _4_ (
    ._0_(_0_),
    ._1_(_1_),
    ._2_(_2_),
    .clk(clk),
...
module interface_primitive_example_design_5(in, ibuf2_en, rst, clk, ibuf1_en, ibuf3_en, ibuf4_en, ibuf5_en, obuft_ds_en1, obuft_ds_en2, obuft_ds_en3, iddr_en, q_p, iddr_out, dffre_out, rst_i_buf_out, _0_, _1_, _2_);
  output _0_;
  output _1_;
  output _2_;
  input clk;

...
, ibuf9_en, ibuf10_en, ibuf11_en, ibuf12_en, ibuf13_en, ibuf14_en, ibuf15_en, ibuf16_en);
  ...
  TDP_RAM18KX2 #(
    ...
    .CLK_B1(clk),
    .CLK_B2(1'hx),
    .RDATA_A1({ _17_[15:9], _15_[8], _14_[7:1], _10_ }),
    .RDATA_A2({ _18_[15:1], _16_ }),
    .RDATA_B1(_19_[15:0]),
    .RDATA_B2(_20_[15:0]),
    .REN_A1(1'h1),
    .REN_A2(1'hx),
    .REN_B1(1'h0),
    .REN_B2(1'h0),
    .RPARITY_A1(_17_[17:16]),
    .RPARITY_A2(_18_[17:16]),
    .RPARITY_B1(_19_[17:16]),
    .RPARITY_B2(_20_[17:16]),
    .WDATA_A1(16'hxxxx),
    .WDATA_A2(16'hxxxx),
  ...
  assign _18_[0] = _16_;
  assign _17_[8:0] = { _15_[8], _14_[7:1], _10_ };
  assign _15_[7:0] = { _14_[7:1], _10_ };
  assign _14_[0] = _10_;

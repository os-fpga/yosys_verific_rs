...
module wrapper_primitive_example_design_1(clk, in, rst, Q, mux1_sel, mux2_sel, P, G, ram_addr, ram_we, buft_out, obuft_oe, ibuf0_en, ibuf1_en, ibuf2_en, ibuf3_en, ibuf4_en, ibuf5_en, ibuf6_en, ibuf7_en, ibuf8_en
, ibuf9_en, ibuf10_en, ibuf11_en, ibuf12_en, ibuf13_en, ibuf14_en, ibuf15_en, ibuf16_en);
  ...
  (* src = "./rtl/primitive_example_design_1.v:5.101-5.110" *)
  wire ibuf10_en;
  primitive_example_design_1 \$auto$rs_design_edit.cc:559:execute$669  (
    .clk(clk),
  ...
  interface_primitive_example_design_1 \$auto$rs_design_edit.cc:561:execute$670  (
    .G(G),
    .P(P),
    .Q(Q),
    .buft_out(buft_out),

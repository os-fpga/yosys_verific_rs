...
module GJC46_post_synth(reset, enable_n, data_i, bitslip_ctrl_n, clkGHz, data_o, ready);
  ...
  I_SERDES #(
    ...
    .PLL_CLK(pll_clk),
    .PLL_LOCK(1'h1),
    .Q({ \data_i_serdes_ , \data_i_serdes[8] , \data_i_serdes[7] , \data_i_serdes[6] , \data_i_serdes[5] , \data_i_serdes[4] , \data_i_serdes[3] , \data_i_serdes[2] , \data_i_serdes[1] , \data_i_serdes[0]  }),

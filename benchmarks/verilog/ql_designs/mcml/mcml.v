...
dual_port_ram #(.AWIDTH(13), .DWIDTH(32), .DEPTH(8192) )
dpram1(	
  .clk (clk),
  .we1(wren),
  .we2(const_zero),
...
dual_port_ram #(.AWIDTH(16), .DWIDTH(36), .DEPTH(65536) )
dpram1(	
  .clk (clk),
  .we1(wren),
  .we2(const_zero),
...
dual_port_ram #(.AWIDTH(16), .DWIDTH(18), .DEPTH(65536) )
dpram1(	
  .clk (clk),
  .we1(wren),
  .we2(const_zero),
...
dual_port_ram #(.AWIDTH(16), .DWIDTH(8), .DEPTH(65536) )
dpram1(	
  .clk (clk),
  .we1(wren),
  .we2(const_zero),
...
module dual_port_ram #(parameter AWIDTH = 5,
